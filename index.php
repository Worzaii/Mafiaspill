...
<section>
    <div class="wrapper">
        <div id="shadow"></div>
        <div id="information">
            <p>Dette er en melding for å vise varsler i forhold til spillet.<br>
                Det vil inkluderes en funksjon i spillet for å oppdatere denne i adminpanelet
                på et tidspunkt.</p>
        </div>
        <div id="content">
            <ul>
            ...
            <div id="register">
                ...
                <p>Du kan kun sende &eacute;n mail hver halvtime, så om du ikke klarer det første
                    gangen må
                    du vente en stund, så pass på at du skriver riktig e-postadresse når
                    du skal motta
                    registreringslink. Alternativt, ta kontakt med ledelsen
                    på <?= HENVEND_MAIL_SAFE ?></p>
            ...
            <div id="rules">
                ...
                <div class="regler">
                    <div class="wrap">
                        <h3>1. Brukerkonto</h3>
                        <ol>
                            <li>Du har ikke lov å bruke flere brukerkontoer samtidig. Men om
                                en person spiller
                                sammen med deg på samme nett,
                                så er du pålagt å si ifra til Ledelsen direkte via
                                Melding. Er ingen i
                                ledelsen aktive, så får du vente med
                                å si det til senere. Evt. send det inn på Support slik
                                at vi kan lese det
                                senere.
                            </li>
                            <li>Du er den eneste som har ansvaret for brukeren, det vil si at du
                                ikke har lov til
                                å la andre bruke din bruker til å få erfaring for
                                deg.
                            </li>
                            <li>Du har ikke på noen måte lov å bruke et
                                program/javascript eller
                                lignende til å få brukeren din til å ranke opp
                                imens du ikke er
                                tilstede. Det skal alltid være du som ranker spilleren,
                                ingenting annet.
                            </li>
                        </ol>
                        <h3>2. <em title="Chat/Forum/Meldinger/Support">Kommunikasjon</em></h3>
                        <ol>
                            <li>Der du kan dele og skrive med andre vil det være restriksjoner
                                til hva du kan
                                skrive. Se under:
                                <ol>
                                    <li>Du har ikke lov å reklamere for noen nettsider. Unntak
                                        kan komme...
                                    </li>
                                    <li>Du har nødt til å følge Norsk lovverk,
                                        ingen unntak vil
                                        forekomme.
                                    </li>
                        ...
                        <h3>3. Din profil</h3>
                        <ol>
                            <li>Du har selv ansvaret for hva du velger å legge ut på din
                                profil, men det må
                                på ingen måte stride med det norske lovverk. Du må
                                heller ikke bryte følgende
                                regler:
                                <ul class="regler">
                        ...
                        <ol>
                            <li>Du er pliktig til å informere Ledelsen om du finner feil i
                                spillet.
                            </li>
                            <li>Mister du verdier, skal det rapporteres til Ledelsen. Når du
                                rapporterer skal du
                                beskrive så grundig du kan akkurat hva du gjorde og hva du
                                mistet. Om du ikke
                                husker det, så kan Ledelsen prøve å finne det ut
                                for deg.
                            </li>
                        </ol>
                    </div>
            ...
            <div id="info">
                <h2>Informasjon</h2>
                <p>Når du logger inn eller registrerer deg hos oss vil en del informasjon bli
                    sendt inn til oss.
                ...
                <p>Vi bruker denne informasjonen vil bli brukt for å forbedre din opplevelse
                    av spillet, slik at
                    vi på best mulig måte kan gjøre spillet bedre for nettopp
                    deg, og alle andre som
                    spiller spillet. Om du har spørsmål, så kan du ta kontakt, se
                    denne siden: <a
            ...
            <div id="kontakt">
                <h2>Kontakt</h2>
                <h1>E-post:</h1>
                <p style="cursor: pointer" title="Klikk for å vise mail url."
                   onclick="this.title = '';
