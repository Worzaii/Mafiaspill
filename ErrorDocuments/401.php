...
<p>Hvis du mener at dette er feil, send en e-post ved å <a
            href="mailto:werzairenet@getmail.no?Subject=<?php echo (rawurlencode("\u{00D8}nsker tilgang")) ?>&Body=<?php echo (rawurlencode("IP-adresse: " . $_SERVER['REMOTE_ADDR'] . "\nLegg til kommentar her:\n\n")) ?>">trykke
        her</a> og fylle inn følgende informasjon: </p>
<p>IP-adresse: <?php echo $_SERVER['REMOTE_ADDR']; ?></p>
</body>
</html>
