...
CREATE TABLE IF NOT EXISTS `bilgarasje` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15836 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `billogg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25407 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `bjtables` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7272 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `bunkerinv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=latin1 COLLATE=latin1_danish_ci;
...
CREATE TABLE IF NOT EXISTS `chance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1922 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `infoin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 COLLATE=latin1_danish_ci;
...
CREATE TABLE IF NOT EXISTS `invsjekk` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=163 DEFAULT CHARSET=latin1 COLLATE=latin1_danish_ci;
...
CREATE TABLE IF NOT EXISTS `jail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9817 DEFAULT CHARSET=latin1;
...
(7, 'Stjel penger fra en tilfeldig forbigende', 150, 10000, 0.90, 30, 40, 1),
(2, 'Ran deg inn p en Narvesen og stjel pengene du finner i butikken', 500, 30000, 0.80, 35, 45, 2),
(3, 'Tigg penger hos kjente og ukjente!', 1000, 45000, 0.70, 50, 70, 3),
(4, 'Knus vinduet p en bil og se etter verdisaker', 1125, 50000, 0.60, 70, 90, 4),
(5, 'Selg tyvegods p ebay!', 1500, 70000, 0.45, 90, 90, 5),
(1, 'Hack nettbanken!', 1600, 120000, 0.35, 100, 120, 7),
(6, 'Stjel lommebkkkkkkkker fra nre venner.', 1650, 100000, 0.21, 110, 90, 6);
...
CREATE TABLE IF NOT EXISTS `krimlogg` (
  ...
  `resu` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=30269 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lodd` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4699 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `paymentcheck` (
  ...
  `time` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=latin1 COLLATE=latin1_danish_ci;
...
CREATE TABLE IF NOT EXISTS `reg_reqs` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`)
) ENGINE=MyISAM AUTO_INCREMENT=210 DEFAULT CHARSET=latin1 COLLATE=latin1_danish_ci;
