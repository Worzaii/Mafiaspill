<?php
	...
	$width  	= 120;	// lengden på bagrunnnnen
	$height 	=  40;	// høyden på bakgrunnenn
	$length 	=  rand(3,7);	// en rand mellom 3 og 7 på bokstavenen/tallene
	$baseList 	= '0123456789abcdfghjkmnpqrstvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'; // bokstaver og tall som vil komme opp på bildet
	$code    	= "";	// NB!! la denne stå tom!nu
	$counter 	= 0;
