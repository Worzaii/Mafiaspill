<?php
  if(! defined('BASEPATH') ){ die('Ingen tilgang!'); }
...
$sefeil=1;
  ...
  define('DOMENE_NAVN','www.westmafia.net');
  define('NAVN_DOMENE','WestMafia');
  define('MAIL_SENDER','westmafia.net');
  /*Konfigurasjon*/
  ...
  session_name("Mafia-no");/*Setter egen session-name ftw*/
  ...
  function safegen($u,$p){
    ...
    return md5(sha1($u.$p.$ua.$l.$i."fu19E@.µWW7"));
  }
//  header("Content-Type: text/html; charset=UTF-8");
  ...
  if (isset($_SESSION['HTTP_USER_AGENT']))
  {
    ...
    {
      session_destroy();
      header('Location: http://mafia-no.net/');
