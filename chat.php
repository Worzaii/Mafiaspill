...
<?php
if (r1() || r2() || r3()) {
    echo "<p class=\"feil\"><a href=\"tomprat.php\" onclick=\"return confirm('Sikker p&aring; at du vil t&oslash;mme prat?')\">T&oslash;m prat - Burde ikke t&oslash;mmes f&oslash;r det er minst 3 dager gammelt, eller over 150 beskjeder i praten!</a></p>
