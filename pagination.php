<?php
	class Pagination
	{
		...
		function GetPageLinks()
		{
			...
			{
				$links .= $begin / $this->per_page <= 1 ? '<span class="prev">Forrige</span> ' : '<a href="'.$this->GetLinkHref($this->current_page-1).'" class="prev">Forrige</a> ';
				...
				$links .= $this->current_page >= $this->GetNumPages() ? '<span class="next">Neste</span>' : '<a href="'.$this->GetLinkHref($this->current_page+1).'" class="next">Neste</a>';
			}
