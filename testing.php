...
<button onclick="notifypres()">Gi meg et varsel! (Stjel)</button><br><br><h1>Send varsel melding fra ledelsen</h1><br>
<form method="post" name="ledmes">
<textarea id="ledmes" style="width:100%;height:600px" placeholder="Skriv meldingen her!" name="tekst"></textarea><br>
